...
for REPO in $REPOS; do
  ...
  PR_RESULT=$(gh pr create -R "HITSZ-OpenAuto/$REPO" -B main -H "$BRANCH_NAME" -t "ci: updated worktree.json generation[automated-generated-PR]" -b "更新生成 worktree 文件的脚本" 2>&1)
  PR_EXIT_CODE=$?
